      ...
      <div className="bg-gradient-to-br from-gray-100 to-gray-300 min-h-screen flex flex-col items-center">
        <div className="max-w-3xl mx-auto mt-16 p-10 bg-white rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            Welcome to <strong>Blog Explorer</strong>, your go-to space for sharing and discovering ideas, stories, and knowledge! 
            Whether you're here to write, read, or explore, we aim to provide a seamless and enjoyable experience for all. 
          </p>

          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Our Mission</h2>
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            We believe in the power of words and ideas to connect people. Our mission is to create an inclusive platform where everyone 
            can freely express their thoughts, share their expertise, and connect with like-minded individuals.
          </p>
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            At Blog Explorer, we’re more than just a blog platform. We’re a community. 
            Whether you're a seasoned writer, a budding blogger, or simply someone who loves to read, 
            we invite you to join us on this journey. Your voice matters, and we’re here to amplify it.
          </p>
